...
class QLearningAgent:
    def __init__(self, world_size, learning_rate=0.1, discount_factor=0.9, exploration_rate=0.7):
    ...
    def choose_action(self, state, mode='train'):
        if mode == 'play' or (mode == 'train' and random.random() < self.exploration_rate):
